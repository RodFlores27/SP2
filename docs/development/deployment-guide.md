...
3. Share demo credentials only over a private channel; seeded passwords are documented in [`../architecture/PROJECT-ORGANIZATION.md`](../architecture/PROJECT-ORGANIZATION.md).
...
See `supabase-auth.md` for the full Google OAuth, Resend SMTP, and DNS checklist. Use `../tests/email-testing-checklist.md` for the end-to-end auth and booking email test pass.
