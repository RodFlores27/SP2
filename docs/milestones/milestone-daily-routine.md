...
- [ ] Check `milestone_reports/README.md` to confirm what is already complete
...
Run the full Sync & Seal from `docs/workflows/milestone-sync-seal.md`. Quick checklist:

- [ ] **Test script** created at `milestone_tests/milestone-{N}-{kebab-case}.js`
