...
- `../../development/kafka-local-dev.md` documents Docker startup, shutdown, reset, and required env vars.
...
- [x] `../../architecture/PROJECT-ORGANIZATION.md` updated for new files.
- [x] `../../tests/milestone_tests/README.md` updated.
- [x] `README.md` updated.
