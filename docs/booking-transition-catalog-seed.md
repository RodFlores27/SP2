...
| P-02  | —                                   | `penciled`                                   | Same, but `openEpisode` after create                             | User       | Foreign pencils overlap + `confirmContention`; defender was `penciled`                                | Defender **same row** → `contested` (P-03); challenger becomes `contesting`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
