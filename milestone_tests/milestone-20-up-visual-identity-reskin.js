...
async function testMilestone20() {
  ...
  expectIncludes('docs/design/up-visual-identity-reskin.md', '# UP Visual Identity Reskin Brief', 'Reskin brief exists');
  expectIncludes('docs/design/up-visual-identity-reskin.md', 'The UP Seal and the Oblation must not be used.', 'Reskin brief preserves Seal/Oblation boundary');
  expectNotIncludes('docs/design/up-visual-identity-reskin.md', 'UPLB ICropS', 'Reskin brief avoids UPLB ICropS naming');
